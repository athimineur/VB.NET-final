Public Class Easy3
    ...
    Private Sub Easy3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        lblScore.Text = intScore ' updates score
    End Sub

    Private Sub btnEnter_Click(sender As Object, e As EventArgs) Handles btnEnter.Click
        ' check to see if answer is 3
        ' if it's not 3...
        If txtCats.Text <> 3 Then
            MessageBox.Show("Sorry, that is incorrect.", "Incorrect")
            bolFail = True
            txtCats.Focus()
            ' if it is 3...
        ElseIf txtCats.Text = 3 Then
            MessageBox.Show("Good job!", "Correct")
            btnEnter.Enabled = False
            btnNextLevel.Visible = True
            txtCats.Enabled = False
