Public Class Easy2
    ...
    Private Sub btnApple_Click(sender As Object, e As EventArgs) Handles clpApple.Click
    ...
    Private Sub clpGrass_Click(sender As Object, e As EventArgs) Handles clpGrass.Click
        ' If you click the right button...show good job message
        MessageBox.Show("Good job!", "Correct")
        ' disable and enable buttons
        clpApple.Enabled = False
        clpGrass.Enabled = False
    ...
    Private Sub Easy2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
