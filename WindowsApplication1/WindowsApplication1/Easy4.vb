Public Class Easy4
    ...
    Private Sub btnEnter_Click(sender As Object, e As EventArgs) Handles btnEnter.Click
        ' Checks to see if you selected the right check boxes
        If boxBlueSquare.Checked = True And boxRedSquare.Checked = True Then
            MessageBox.Show("Good job!", "Correct")
            btnEnter.Enabled = False
            btnNextLevel.Visible = True
            ' Disable check boxes
            boxBlueSquare.Enabled = False
            boxRedSquare.Enabled = False
            boxYellowTriangle.Enabled = False
    ...
    Private Sub Easy4_Load(sender As Object, e As EventArgs) Handles MyBase.Load
